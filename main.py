...
def setup_paint_app(window):
    ...
    # 스프레이 버튼
    button_spray = Button(brush_button_frame, text="Spray", command=lambda: canvas.bind("<B1-Motion>", spray_brush.spray_paint))
...
def create_new_window():
    ...
    new_window.geometry("1200x850+200+200")
...
window.geometry("1200x850+200+200")
