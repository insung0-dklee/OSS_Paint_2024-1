...
def change_bg_color():
    ...
    label_bg_color.config(bg=bg_color[1])
...
def change_brush_color():
    ...
    if color:
        brush_color = color
        label_brush_color.config(bg=brush_color)
...
brush_color = "black"
button_brush_color = Button(window, text="펜 색", command=change_brush_color)
button_brush_color.pack(side=LEFT)
label_brush_color = Label(window, bg=brush_color, width=5)
label_brush_color.pack(side=LEFT)

bg_color = "white"
button_bg_color = Button(window, text="Change Background Color", command=change_bg_color)
button_bg_color.pack(side=LEFT)
label_bg_color = Label(window, bg=bg_color, width=5)
label_bg_color.pack(side=LEFT)
